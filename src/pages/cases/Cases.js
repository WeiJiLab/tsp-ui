...
import {faChevronRight, faCube, faEllipsisH, faTh, faThList} from "@fortawesome/free-solid-svg-icons";
import {bindActionCreators} from "redux";
import {connect} from "react-redux";
import {Link} from "react-router-dom";
import {setBreadCrumbMenu} from "../../actions/BreadCrumbMenuAction";
import {deleteCase, getCases} from "../../actions/CasesAction";
...
class Cases extends React.Component {
    ...
    render() {
        return <Container className={'Cases'}>
                    ...
                    <Col md={11}>
                        ...
                        <Row>
                            <Col md={10}>
                                ...
                                {/*<span>{cas.applications.length}</span>&nbsp;&nbsp;&nbsp;*/}
