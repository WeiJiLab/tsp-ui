...
class HttpApiService {
  ...
  private handleAxiosInstance() {
    ...
    this._axiosInstance.interceptors.response.use(
      httpResponseHandler.handleSuccess,
      httpResponseHandler.handleError,
    );
  }
  ...
  public post(endpoint: string, data: any, conf = {}): AxiosPromise {
    return new Promise((resolve, reject) => {
      this._axiosInstance
  ...
  public put(endpoint: string, data: any, conf = {}): AxiosPromise {
    return new Promise((resolve, reject) => {
      this._axiosInstance
  ...
  public patch(endpoint: string, data: any, conf = {}): AxiosPromise {
    return new Promise((resolve, reject) => {
      this._axiosInstance
